...
namespace WallpaperUtilities
{
    ...
    public static class Wallpaper
    {
        ...
        /// <exception cref="ArgumentException"><paramref name="sourceFileName" /> or <paramref name="destFileName" /> is a zero-length string, contains only white space, or contains invalid characters as defined in <see cref="F:System.IO.Path.InvalidPathChars" />. </exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException">The time-out value is negative and is not equal to <see cref="F:System.Threading.Timeout.Infinite" />. </exception>
        ...
        /// parameter path.
        /// </summary>
        /// <param name="path">the path to the image file to set as the
        /// lockscreen wallpaper</param>
        /// <exception cref="ArgumentNullException"><paramref name="fileName" />
        /// is null. </exception>
        /// <exception cref="ArgumentException">The file name is empty, contains
        /// only white spaces, or contains invalid characters. </exception>
        ...
        /// <exception cref="NotSupportedException"><paramref name="fileName" />
        ...
        /// <paramref name="fileName" /> is denied. </exception>
        /// <exception cref="DirectoryNotFoundException">
        /// <paramref name="path" /> is invalid, such as referring to an
        /// unmapped drive. </exception>
        /// <exception cref="IOException"><paramref name="path" /> is a file
        /// name.</exception>
        /// <exception cref="ArgumentOutOfRangeException">The time-out value is
        /// negative and is not equal to 
        /// <see cref="F:System.Threading.Timeout.Infinite" />. </exception>
        /// <exception cref="ObjectDisposedException">The process object has
        /// already been disposed. </exception>
        /// <exception cref="FileNotFoundException">The PATH environment
        /// variable has a string containing quotes.</exception>
    ...
    //UWP version - Sends the image data over a TCP socket (only way to send that much data into a UWP app from a Windows app)
        ...
        /// <exception cref="DirectoryNotFoundException">The path encapsulated in the <see cref="T:System.IO.DirectoryInfo" /> object is invalid (for example, it is on an unmapped drive). </exception>
        /// <exception cref="PathTooLongException">The fully qualified path and file name is 260 or more characters.</exception>
        /// <exception cref="SecurityException">The caller does not have the required permission. </exception>
        /// <exception cref="ArgumentException"><paramref name="path" /> contains one or more of the invalid characters defined in <see cref="M:System.IO.Path.GetInvalidPathChars" />.  </exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="s" /> is
        /// null. </exception>
        /// <exception cref="FormatException"><paramref name="s" /> is not in
        /// the correct format. </exception>
        /// <exception cref="OverflowException"><paramref name="s" /> represents
        /// a number less than <see cref="F:System.Int32.MinValue" /> or greater
        /// than <see cref="F:System.Int32.MaxValue" />. </exception>
        /// <exception cref="SecurityException">The caller does not have the
        /// required permission. </exception>
        /// <exception cref="IOException">The directory specified by 
        /// <paramref name="path" /> is a file.-or-The network name is not
        /// known.</exception>
        /// <exception cref="UnauthorizedAccessException">The caller does not
        /// have the required permission. </exception>
        /// <exception cref="Win32Exception">An error occurred when opening the
        /// associated file. </exception>
        /// <exception cref="FileNotFoundException">The PATH environment
        /// variable has a string containing quotes.</exception>
        /// <exception cref="DirectoryNotFoundException">The path encapsulated
        ...
        {
            if (args.Length == 0 || !(args.Length > 0 && new List<string> { "-d", "--desktop", "-l", "--lock screen" }.Contains(args[0])))
            {
